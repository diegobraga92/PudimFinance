...
export interface components {
    schemas: {
        ...
        /** @description Request body for completing a Google OAuth authorization-code flow. */
        GoogleAuthRequest: {
            /** @description Public OAuth client ID used for the authorization request. */
            client_id: string;
            /** @description Authorization code returned by Google. */
            code: string;
            /** @description PKCE verifier generated by the client. */
